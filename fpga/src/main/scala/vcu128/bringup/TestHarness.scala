...
import chipyard.fpga.vcu128.{VCU128FPGATestHarness, VCU128FPGATestHarnessImp, DDR2VCU128ShellPlacer, SysClock2VCU128ShellPlacer}

import chipyard.{ChipTop}

class BringupVCU128FPGATestHarness(override implicit val p: Parameters) extends VCU128FPGATestHarness {
  ...
  val uart_fmc = Overlay(UARTOverlayKey, new BringupUARTVCU128ShellPlacer(this, UARTShellInput()))
  ...
  val i2c = Overlay(I2COverlayKey, new BringupI2CVCU128ShellPlacer(this, I2CShellInput()))
  ...
  val gpio = Seq.tabulate(dp(PeripheryGPIOKey).size)(i => {
    ...
    Overlay(GPIOOverlayKey, new BringupGPIOVCU128ShellPlacer(this, GPIOShellInput(), names))
  })
  ...
  val tsi_host = Overlay(TSIHostOverlayKey, new BringupTSIHostVCU128ShellPlacer(this, TSIHostShellInput()))
  ...
  override lazy val module = new BringupVCU128FPGATestHarnessImp(this)
}

class BringupVCU128FPGATestHarnessImp(_outer: BringupVCU128FPGATestHarness) extends VCU128FPGATestHarnessImp(_outer) {
